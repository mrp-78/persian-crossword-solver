...
es_index = config('ES_WIKIPEDIA_INDEX_NAME')
logging.basicConfig(
            ...
            "properties": {
                "InfoBox": {
                    "properties": {
                        "KeysAndValues": {
                            "properties": {
                                "Item1": {"type": "text", "analyzer": "parsi"},
                                "Item2": {"type": "text", "analyzer": "parsi"}
                            }
                        },
                        "Title": {"type": "text", "analyzer": "parsi"}
                    }
                },
                "Links": {"type": "text", "analyzer": "parsi"},
                "RedirectList": {"type": "text", "analyzer": "parsi"},
                "Text": {"type": "text", "analyzer": "parsi"},
                "Title": {"type": "text", "analyzer": "parsi"},
                "Parents": {"type": "text", "analyzer": "parsi"}
            }
        }
    })
